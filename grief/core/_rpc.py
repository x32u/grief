...
class RPCMixin:
    ...
    def register_rpc_handler(self, method):
        ...
        .. important::
            RPC support is included in grief on a provisional basis. Backwards incompatible changes (up to and including removal of the RPC) may occur if deemed necessary.
